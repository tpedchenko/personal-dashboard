...
export type TelegramLinkWhereInput = {
  ...
  telegramId?: Prisma.IntFilter<"TelegramLink"> | number
  userEmail?: Prisma.StringFilter<"TelegramLink"> | string
...
export type TelegramLinkScalarWhereWithAggregatesInput = {
  ...
  telegramId?: Prisma.IntWithAggregatesFilter<"TelegramLink"> | number
  userEmail?: Prisma.StringWithAggregatesFilter<"TelegramLink"> | string
...
export type TelegramLinkOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"telegramId" | "userEmail" | "telegramUsername", ExtArgs["result"]["telegramLink"]>
...
export interface TelegramLinkDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const telegramLinkWithTelegramIdOnly = await prisma.telegramLink.findMany({ select: { telegramId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many TelegramLinks and only return the `telegramId`
   * const telegramLinkWithTelegramIdOnly = await prisma.telegramLink.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more TelegramLinks and only return the `telegramId`
   * const telegramLinkWithTelegramIdOnly = await prisma.telegramLink.updateManyAndReturn({
   *   select: { telegramId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface TelegramLinkFieldRefs {
  readonly telegramId: Prisma.FieldRef<"TelegramLink", 'Int'>
  readonly userEmail: Prisma.FieldRef<"TelegramLink", 'String'>
